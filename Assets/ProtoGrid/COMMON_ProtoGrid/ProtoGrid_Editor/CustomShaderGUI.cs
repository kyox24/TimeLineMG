...
public class CustomShaderGUI : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        if (showingGrid)
        {
            ...
            gridTexture = EditorGUILayout.ObjectField("Grid Texture", gridTexture, typeof(Texture2D), false) as Texture2D;
            targetMat.SetTexture(ST_Grid_Texture, gridTexture);
            EditorGUILayout.Space(smallSpacing);
            // Grid Size
            gridSize = targetMat.GetFloat(ST_GridSize);
            //TO DELETE// gridSize = EditorGUILayout.Slider("Grid Size",gridSize, 0, 100, GUILayout.MinWidth(180f), GUILayout.MaxWidth(3000), GUILayout.Height(20));
            ...
            groundBackGroundTexture = EditorGUILayout.ObjectField("Background Texture", groundBackGroundTexture, typeof(Texture2D), false) as Texture2D;
            ...
            //TO DELETE// groundBackGroundSize = EditorGUILayout.Slider("BackGround Size", groundBackGroundSize, 0, 100, GUILayout.MinWidth(180f), GUILayout.MaxWidth(3000), GUILayout.Height(20));
        ...
        if (enableDistinction)
        {
            ...
            if (showingWallGrid)
            {
                ...
                wallBackGroundTexture = EditorGUILayout.ObjectField("Wall Background Texture", wallBackGroundTexture, typeof(Texture2D), false) as Texture2D;
                ...
                // TO DELETE// wallBackGroundSize = EditorGUILayout.Slider("Wall BackGround Size", wallBackGroundSize, 0, 100, GUILayout.MinWidth(180f), GUILayout.MaxWidth(3000), GUILayout.Height(20));
